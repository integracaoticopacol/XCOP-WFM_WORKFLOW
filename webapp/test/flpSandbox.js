		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#xcopwfmmanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"xcopwfmmanager-display": {
								"semanticObject": "xcopwfmmanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=xcop.wfm.manager",
									"url": sap.ui.require.toUrl("xcop/wfm/manager")
								}
							}
						}
					}
